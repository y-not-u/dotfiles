...
require("lazy").setup({
  ...
  },
  {
    ...
    config = function()
      ...
      lsp.format_on_save({
        ...
        servers = {
          ['lua_ls'] = { 'lua' },
          ['null-ls'] = { 'html', 'javascript', 'javascriptreact', 'typescript', 'typescriptreact', 'css', 'json', 'tsx' },
        }
      })
  ...
  { "iamcco/markdown-preview.nvim" }, -- markdown preview need to build first
  {
    ...
    keys = {
      ...
      { "<F5>",       ":Lspsaga term_toggle<CR>", desc = "Floating terminal" },
